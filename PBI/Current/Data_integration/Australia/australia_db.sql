...
--
-- Host: 127.0.0.1
-- Tempo de geração: 08-Abr-2021 às 21:02
...
INSERT INTO `customers_w_ter` (`CUSTOMERNUMBER`, `NAME`, `PHONE`, `ADDRESSLINE1`, `CITY`, `STATE`) VALUES
...
INSERT INTO `orders` (`ORDERNUMBER`, `ORDERDATE`, `DATE`, `SHIPPEDDATE`, `CUSTOMERNUMBER`) VALUES
...
CREATE TABLE `products` (
  ...
  `PRICEINAUD` decimal(16,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `products` (`PRODUCTCODE`, `PRODUCTNAME`, `PRODUCTVENDOR`, `QUANTITYINSTOCK`, `MSRP`, `PRODUCTLINE`, `PRICEINAUD`) VALUES
('S10_1678', '1969 Harley Davidson Ultimate Chopper', 'Min Lin Diecast', 7933, 96, 'Motorcycles', '64.19'),
('S10_1949', '1952 Alpine Renault 1300', 'Classic Metal Creations', 7305, 214, 'Classic Cars', '129.69'),
('S10_2016', '1996 Moto Guzzi 1100i', 'Highway 66 Mini Classics', 6625, 119, 'Motorcycles', '90.39'),
('S10_4698', '2003 Harley-Davidson Eagle Drag Bike', 'Red Start Diecast', 5582, 194, 'Motorcycles', '119.21'),
('S10_4962', '1962 LanciaA Delta 16V', 'Second Gear Diecast', 6791, 148, 'Classic Cars', '134.93'),
('S12_1099', '1968 Ford Mustang', 'Autoart Studio Design', 68, 195, 'Classic Cars', '124.45'),
('S12_1666', '1958 Setra Bus', 'Welly Diecast Productions', 1579, 137, 'Trucks and Buses', '102.18'),
('S12_2823', '2002 Suzuki XREO', 'Unimax Art Galleries', 9997, 151, 'Motorcycles', '86.46'),
('S12_3990', '1970 Plymouth Hemi Cuda', 'Studio M Art Models', 5663, 80, 'Classic Cars', '41.92'),
('S18_1097', '1940 Ford Pickup Truck', 'Studio M Art Models', 2613, 117, 'Trucks and Buses', '75.98'),
('S18_1129', '1993 Mazda RX-7', 'Highway 66 Mini Classics', 3975, 142, 'Classic Cars', '110.04'),
('S18_1342', '1937 Lincoln Berline', 'Motor City Art Classics', 8693, 103, 'Vintage Cars', '79.91'),
('S18_1367', '1936 Mercedes-Benz 500K Special Roadster', 'Studio M Art Models', 8635, 54, 'Vintage Cars', '31.44'),
('S18_1589', '1965 Aston Martin DB5', 'Classic Metal Creations', 9042, 124, 'Classic Cars', '86.46'),
('S18_1749', '1917 Grand Touring Sedan', 'Welly Diecast Productions', 2724, 170, 'Vintage Cars', '113.97'),
('S18_1889', '1948 Porsche 356-A Roadster', 'Gearbox Collectibles', 8826, 77, 'Classic Cars', '70.74'),
('S18_1984', '1995 Honda Civic', 'Min Lin Diecast', 9772, 142, 'Classic Cars', '123.14'),
('S18_2248', '1911 Ford Town Car', 'Motor City Art Classics', 540, 61, 'Vintage Cars', '43.23'),
('S18_2319', '1964 Mercedec Tour Bus', 'Unimax Art Galleries', 8258, 123, 'Trucks and Buses', '98.25'),
('S18_2325', '1932 Model A Ford J-Coupe', 'Autoart Studio Design', 9354, 127, 'Vintage Cars', '75.98'),
('S18_2432', '1926 Ford Fire Engine', 'Carousel DieCast Legends', 2018, 61, 'Trucks and Buses', '32.75'),
('S18_2581', 'P-51-D Mustang', 'Gearbox Collectibles', 992, 84, 'Planes', '64.19'),
('S18_2625', '1936 Harley Davidson El Knucklehead', 'Welly Diecast Productions', 4357, 61, 'Motorcycles', '31.44'),
('S18_2795', '1928 Mercedes-Benz SSK', 'Gearbox Collectibles', 548, 169, 'Vintage Cars', '95.63'),
('S18_2870', '1999 Indy 500 Monte Carlo SS', 'Red Start Diecast', 8164, 132, 'Classic Cars', '74.67'),
('S18_2949', '1913 Ford Model T Speedster', 'Carousel DieCast Legends', 4189, 101, 'Vintage Cars', '79.91'),
('S18_2957', '1934 Ford V8 Coupe', 'Min Lin Diecast', 5649, 62, 'Vintage Cars', '44.54'),
('S18_3136', '18th Century Vintage Horse Carriage', 'Red Start Diecast', 5992, 105, 'Vintage Cars', '79.91'),
('S18_3232', '1992 Ferrari 360 Spider red', 'Unimax Art Galleries', 8347, 169, 'Classic Cars', '102.18'),
('S18_3278', '1969 Dodge Super Bee', 'Min Lin Diecast', 1917, 80, 'Classic Cars', '64.19'),
('S18_3320', '1917 Maxwell Touring Car', 'Exoto Designs', 7913, 99, 'Vintage Cars', '75.98'),
('S18_3482', '1976 Ford Gran Torino', 'Gearbox Collectibles', 9127, 147, 'Classic Cars', '95.63'),
('S18_3685', '1948 Porsche Type 356 Roadster', 'Gearbox Collectibles', 8990, 141, 'Classic Cars', '81.22'),
('S18_3782', '1957 Vespa GS150', 'Studio M Art Models', 7689, 62, 'Motorcycles', '43.23'),
('S18_3856', '1941 Chevrolet Special Deluxe Cabriolet', 'Exoto Designs', 2378, 106, 'Vintage Cars', '85.15'),
('S18_4027', '1970 Triumph Spitfire', 'Min Lin Diecast', 5545, 144, 'Classic Cars', '120.52'),
('S18_4409', '1932 Alfa Romeo 8C2300 Spider Sport', 'Exoto Designs', 6553, 92, 'Vintage Cars', '56.33'),
('S18_4600', '1940s Ford truck', 'Motor City Art Classics', 3128, 121, 'Trucks and Buses', '111.35'),
('S18_4668', '1939 Cadillac Limousine', 'Studio M Art Models', 6645, 50, 'Vintage Cars', '30.13'),
('S18_4721', '1957 Corvette Convertible', 'Classic Metal Creations', 1249, 149, 'Classic Cars', '91.70'),
('S18_4933', '1957 Ford Thunderbird', 'Studio M Art Models', 3209, 71, 'Classic Cars', '44.54'),
('S24_1046', '1970 Chevy Chevelle SS 454', 'Unimax Art Galleries', 1005, 73, 'Classic Cars', '64.19'),
('S24_1444', '1970 Dodge Coronet', 'Highway 66 Mini Classics', 4074, 58, 'Classic Cars', '41.92'),
('S24_1578', '1997 BMW R 1100 S', 'Autoart Studio Design', 7003, 113, 'Motorcycles', '79.91'),
('S24_1628', '1966 Shelby Cobra 427 S/C', 'Carousel DieCast Legends', 8197, 50, 'Classic Cars', '37.99'),
('S24_1785', '1928 British Royal Navy Airplane', 'Classic Metal Creations', 3627, 109, 'Planes', '87.77'),
('S24_1937', '1939 Chevrolet Deluxe Coupe', 'Motor City Art Classics', 7332, 33, 'Vintage Cars', '30.13'),
('S24_2000', '1960 BSA Gold Star DBD34 1960', 'Highway 66 Mini Classics', 15, 76, 'Motorcycles', '48.47'),
('S24_2022', '1938 Cadillac V-16 Presidential Limousine', 'Classic Metal Creations', 2847, 45, 'Vintage Cars', '27.51'),
('S24_2360', '1982 Ducati 900 Monster', 'Highway 66 Mini Classics', 6840, 69, 'Motorcycles', '61.57'),
('S24_2766', '1949 Jaguar XK 120', 'Classic Metal Creations', 2350, 91, 'Classic Cars', '61.57'),
('S24_2841', '1900s Vintage Bi-Plane', 'Autoart Studio Design', 5942, 69, 'Planes', '44.54'),
('S24_2887', '1952 Citroen-15CV', 'Exoto Designs', 1452, 117, 'Classic Cars', '95.63'),
('S24_2972', '1982 Lamborghini Diablo', 'Second Gear Diecast', 7723, 38, 'Classic Cars', '20.96'),
('S24_3191', '1969 Chevrolet Camaro Z28', 'Exoto Designs', 4695, 86, 'Classic Cars', '66.81'),
('S24_3371', '1971 Alpine Renault 1600s', 'Welly Diecast Productions', 7995, 61, 'Classic Cars', '51.09'),
('S24_3420', '1937 Horch 930V Limousine', 'Autoart Studio Design', 2902, 66, 'Vintage Cars', '34.06'),
('S24_3432', '2002 Chevy Corvette', 'Gearbox Collectibles', 9446, 107, 'Classic Cars', '81.22'),
('S24_3856', '1956 Porsche 356A Coupe', 'Classic Metal Creations', 6600, 140, 'Classic Cars', '128.38'),
('S24_3949', 'Corsair F4U ( Bird Cage)', 'Second Gear Diecast', 6812, 68, 'Planes', '37.99'),
('S24_3969', '1936 Mercedes Benz 500k Roadster', 'Red Start Diecast', 2081, 41, 'Vintage Cars', '28.82'),
('S24_4048', '1992 Porsche Cayenne Turbo Silver', 'Exoto Designs', 6582, 118, 'Classic Cars', '91.70'),
('S24_4258', '1936 Chrysler Airflow', 'Second Gear Diecast', 4710, 97, 'Vintage Cars', '74.67'),
('S24_4278', '1900s Vintage Tri-Plane', 'Unimax Art Galleries', 2756, 72, 'Planes', '47.16'),
('S24_4620', '1961 Chevrolet Impala', 'Classic Metal Creations', 7869, 81, 'Classic Cars', '41.92'),
('S32_1268', '1980?s GM Manhattan Express', 'Motor City Art Classics', 5099, 96, 'Trucks and Buses', '70.74'),
('S32_1374', '1997 BMW F650 ST', 'Exoto Designs', 178, 100, 'Motorcycles', '87.77'),
('S32_2206', '1982 Ducati 996 R', 'Gearbox Collectibles', 9241, 40, 'Motorcycles', '31.44'),
('S32_3207', '1950\'s Chicago Surface Lines Streetcar', 'Gearbox Collectibles', 8601, 62, 'Trains', '35.37'),
('S32_3522', '1996 Peterbilt 379 Stake Bed with Outrigger', 'Red Start Diecast', 814, 65, 'Trucks and Buses', '44.54'),
('S32_4289', '1928 Ford Phaeton Deluxe', 'Highway 66 Mini Classics', 136, 69, 'Vintage Cars', '43.23'),
('S32_4485', '1974 Ducati 350 Mk3 Desmo', 'Second Gear Diecast', 3341, 102, 'Motorcycles', '73.36'),
('S50_1341', '1930 Buick Marquette Phaeton', 'Studio M Art Models', 7062, 44, 'Vintage Cars', '35.37'),
('S50_4713', '2002 Yamaha YZR M1', 'Autoart Studio Design', 600, 81, 'Motorcycles', '44.54'),
('S700_1691', 'American Airlines: B767-300', 'Min Lin Diecast', 5841, 91, 'Planes', '66.81'),
('S700_2047', 'HMS Bounty', 'Unimax Art Galleries', 3501, 91, 'Ships', '52.40'),
('S700_2466', 'America West Airlines B757-200', 'Motor City Art Classics', 9653, 100, 'Planes', '90.39'),
('S700_2824', '1982 Camaro Z28', 'Carousel DieCast Legends', 6934, 101, 'Classic Cars', '61.57'),
('S700_2834', 'ATA: B757-300', 'Highway 66 Mini Classics', 7106, 119, 'Planes', '77.29'),
('S700_3167', 'F/A 18 Hornet 1/72', 'Motor City Art Classics', 551, 80, 'Planes', '70.74'),
('S700_4002', 'American Airlines: MD-11S', 'Second Gear Diecast', 8820, 74, 'Planes', '47.16'),
('S72_1253', 'Boeing X-32A JSF', 'Motor City Art Classics', 4857, 50, 'Planes', '43.23');
COMMIT;
